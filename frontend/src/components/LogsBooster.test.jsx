import React from 'react'; import { render, screen, fireEvent } from '@testing-library/react'; import { describe, it, expect, vi } from 'vitest'; import Logs from '../pages/Logs'; import { MemoryRouter } from 'react-router-dom'; import * as useApiModule from '../hooks/useApi';
