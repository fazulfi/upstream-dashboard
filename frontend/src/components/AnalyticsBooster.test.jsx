import React from 'react'; import { render, screen, fireEvent, waitFor } from '@testing-library/react'; import { describe, it, expect, vi } from 'vitest'; import Analytics from '../pages/Analytics'; import { MemoryRouter } from 'react-router-dom'; import * as useApiModule from '../hooks/useApi';
