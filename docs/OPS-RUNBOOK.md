...
`main` @ `207a259`. `DASHBOARD_PASSWORD` adalah secret server-side (baca dari
...
1. `git pull origin main` di `/home/gamesim/dashboard` (pastikan `main` @ `207a259` atau lebih baru)
