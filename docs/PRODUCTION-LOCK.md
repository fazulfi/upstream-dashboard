...
- **Status**: ✅ DEPLOYED (Phase 4 — 2026-08-21, incl. recon fix PR #21)
- **main commit**: 6025305 (PR #19 Phase 4 Control Plane + PR #20 evidence + PR #21 seed classifier fix)
- **locked at**: 2026-08-21 02:15 UTC (updated 2026-08-21 post PR #21 fix deploy)
- **CI**: green (backend + frontend + Vercel + Preview — PR #19/#20/#21 all checks PASS)
...
- **Backend**: ops.budgezen.com — MainPID 680666 (6025305), finance unit = repo scripts/gen_finance.py + EnvironmentFile /home/gamesim/.dashboard.env; recon PASS (unexplained=0, seed 192 classified)
